...
description: Ottiene o imposta il callback chiamato per creare la risorsa per archiviare limmagine.
type: docs
weight: 100
...
Ottiene o imposta il callback chiamato per creare la risorsa per archiviare l'immagine.
