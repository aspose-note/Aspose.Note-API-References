...
description: Opzioni utilizzate per stampare un documento.
type: docs
weight: 830
...
| Nome | Descrizione |
| --- | --- |
| [DocumentName](../../aspose.note.saving/printoptions/documentname) { get; set; } | Ottiene o imposta il nome del documento da visualizzare (ad esempio, in una finestra di dialogo dello stato di stampa o in una coda della stampante) durante la stampa del documento. |
| [PageSplittingAlgorithm](../../aspose.note.saving/printoptions/pagesplittingalgorithm) { get; set; } | Ottiene o imposta l'algoritmo utilizzato per la divisione delle pagine. |
