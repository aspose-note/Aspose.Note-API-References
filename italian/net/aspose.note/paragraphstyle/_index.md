...
description: Impostazioni dello stile del testo da utilizzare se non è presente alcun oggetto TextStyle corrispondenteStyles raccolta o questo oggetto non specifica unimpostazione necessaria.
type: docs
weight: 490
...
Impostazioni dello stile del testo da utilizzare se non è presente alcun oggetto TextStyle corrispondenteStyles raccolta o questo oggetto non specifica un'impostazione necessaria.
...
| Nome | Descrizione |
| --- | --- |
| [ParagraphStyle](paragraphstyle)() | Inizializza una nuova istanza di[`ParagraphStyle`](../paragraphstyle) classe. |

## Proprietà

| Nome | Descrizione |
| --- | --- |
| static [Default](../../aspose.note/paragraphstyle/default) { get; } | Ottiene ParagraphStyle con le impostazioni predefinite. |
...
| override [GetHashCode](../../aspose.note/paragraphstyle/gethashcode)() | Serve come funzione hash per il tipo. |
