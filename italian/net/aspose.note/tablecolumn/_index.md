...
description: Rappresenta una colonna di tabella.
type: docs
weight: 890
...
Rappresenta una colonna di tabella.
...
| Nome | Descrizione |
| --- | --- |
| [LockedWidth](../../aspose.note/tablecolumn/lockedwidth) { get; set; } | Ottiene o imposta un valore che indica se una colonna della tabella ha una larghezza bloccata e non si ridimensiona automaticamente per adattarsi al contenuto della tabella. Per impostazione predefinita, la larghezza della colonna non è bloccata. |
