...
description: Aspose.Note.TableColumn classe. Rappresenta una colonna della tabella.
type: docs
weight: 920
url: /it/net/aspose.note/tablecolumn/
---
## TableColumn class
...
| Nome | Descrizione |
| --- | --- |
| [TableColumn](tablecolumn/)() | Default_Costruttore |

## Proprietà

| Nome | Descrizione |
| --- | --- |
| [LockedWidth](../../aspose.note/tablecolumn/lockedwidth/) { get; set; } | Ottiene o imposta un valore che indica se una colonna della tabella ha una larghezza bloccata e non viene ridimensionata automaticamente per adattarsi al contenuto della tabella. Per impostazione predefinita, la larghezza della colonna non è bloccata. |
| [Width](../../aspose.note/tablecolumn/width/) { get; set; } | Ottiene o imposta la larghezza. |
