...
description: Ottiene o imposta un valore che indica se Aspose.Note esegue il rilevamento automatico delle modifiche al layout. Il valore predefinito èVERO .
type: docs
weight: 20
...
Ottiene o imposta un valore che indica se Aspose.Note esegue il rilevamento automatico delle modifiche al layout. Il valore predefinito è`VERO` .
