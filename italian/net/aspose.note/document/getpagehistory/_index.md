...
description: Document metodo. Ottiene ilPageHistory che contiene la cronologia completa per ogni pagina presentata in un documento la prima allindice 0. È possibile accedere alla revisione della pagina corrente comeCurrent e contenuto separatamente dalla raccolta delle versioni storiche.
type: docs
weight: 100
...
Ottiene il[`PageHistory`](../../pagehistory/) che contiene la cronologia completa per ogni pagina presentata in un documento (la prima all'indice 0). È possibile accedere alla revisione della pagina corrente come[`Current`](../../pagehistory/current/) e contenuto separatamente dalla raccolta delle versioni storiche.
