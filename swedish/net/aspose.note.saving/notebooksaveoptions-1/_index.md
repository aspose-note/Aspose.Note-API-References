...
description: En abstrakt basklass som representerar anteckningsbokens sparalternativ för ett visst format och ger gemensamma sparalternativ för alla underordnade dokumentnoder.
type: docs
weight: 780
