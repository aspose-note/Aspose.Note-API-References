...
description: Anger numreringsformatet som kan användas för en grupp av automatiskt numrerade objekt. Fullständig lista anges påMSDNhttps//msdn.microsoft.com/en-us/library/dd923798voffice.12.aspx
type: docs
weight: 410
...
| UpperLetter | `3` | Anger att sekvensen ska bestå av en eller flera förekomster av en enstaka bokstav i det latinska alfabetet med versaler. Exempel: A, B, C, …, Y, Z, AA, BB, CC, …, YY, ZZ , AAA, BBB, CCC. |
| LowerLetter | `4` | Anger att sekvensen ska bestå av en eller flera förekomster av en enda bokstav i det latinska alfabetet med gemener. Exempel: a, b, c, …, y, z, aa, bb, cc, …, yy, zz , aaa, bbb, ccc. |
