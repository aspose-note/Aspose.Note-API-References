...
description: Anger måtten på marginalerna för en nod.
type: docs
weight: 310
...
| namn | Beskrivning |
| --- | --- |
| [Margins](margins)(float, float, float, float) | Initierar en ny instans av[`Margins`](../margins) struct med de angivna vänster-, höger-, topp- och bottenmarginalerna. |
