...
description: Upptäcker alla ändringar som gjorts i dokumentlayouten sedan föregåendeDetectLayoutChangesaspose.note/document/detectlayoutchanges ring. I fallAutomaticLayoutChangesDetectionEnabledaspose.note/document/automaticlayoutchangesdetectionenabled inställd på sant används automatiskt i början av dokumentexporten.
type: docs
weight: 90
