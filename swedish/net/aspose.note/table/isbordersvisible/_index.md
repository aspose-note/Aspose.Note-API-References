...
description: Table fast egendom. Hämtar eller ställer in ett värde som anger om tabellkanten är synlig.
type: docs
weight: 30
url: /sv/net/aspose.note/table/isbordersvisible/
---
## Table.IsBordersVisible property

Hämtar eller ställer in ett värde som anger om tabellkanten är synlig.
