...
description: Aspose.Note.ITaggable gränssnitt. Gränssnittet för noder som kan markeras med taggar.
type: docs
weight: 240
url: /sv/net/aspose.note/itaggable/
---
## ITaggable interface

Gränssnittet för noder som kan markeras med taggar.
...
| namn | Beskrivning |
| --- | --- |
| [Tags](../../aspose.note/itaggable/tags/) { get; } | Hämtar listan över alla taggar. |
