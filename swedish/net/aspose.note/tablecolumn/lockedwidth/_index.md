...
description: Hämtar eller ställer in ett värde som anger om en tabellkolumn har låst bredd och inte ändrar storlek automatiskt för att passa tabellinnehåll. Som standard är kolumnbredden inte låst.
type: docs
weight: 20
