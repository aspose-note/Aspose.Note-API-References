...
description: Aspose.Note.TableColumn klass. Representerar en tabellkolumn.
type: docs
weight: 920
url: /sv/net/aspose.note/tablecolumn/
---
## TableColumn class

Representerar en tabellkolumn.
...
| namn | Beskrivning |
| --- | --- |
| [LockedWidth](../../aspose.note/tablecolumn/lockedwidth/) { get; set; } | Hämtar eller ställer in ett värde som anger om en tabellkolumn har låst bredd och inte ändrar storlek automatiskt för att passa tabellinnehåll. Som standard är kolumnbredden inte låst. |
| [Width](../../aspose.note/tablecolumn/width/) { get; set; } | Hämtar eller ställer in bredden. |
