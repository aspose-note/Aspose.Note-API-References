...
description: MergeOptions fast egendom. Hämtar eller ställer in ett värde som anger om tillhandahållna sidor ska importeras som enstaka sidor.
type: docs
weight: 20
url: /sv/net/aspose.note/mergeoptions/importassinglepage/
---
## MergeOptions.ImportAsSinglePage property

Hämtar eller ställer in ett värde som anger om tillhandahållna sidor ska importeras som enstaka sidor.
