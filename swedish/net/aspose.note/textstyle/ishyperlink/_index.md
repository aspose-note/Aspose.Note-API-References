...
description: TextStyle-egenskap. Föråldrad sedan version 22.5. Använd HyperlinkAddress i stället.
type: docs
weight: 80
...
Föråldrad sedan version 22.5. Använd `HyperlinkAddress` i stället.
