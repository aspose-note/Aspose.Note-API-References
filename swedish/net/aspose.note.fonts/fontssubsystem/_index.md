...
description: Basklass som implementerar Aspose.Note.Fonts.IFontsSubsystem-gränssnitt. Ger funktionalitet för standardteckensnitt och teckensnittsersättningar. Åsidosätt Aspose.Note.Fonts.FontsSubsystem.FetchFetchFontFamily-skyddad medlemsklass för att implementera en logga-härledd medlemsklass för att hämta hemFontFamily objekt.
type: docs
weight: 110
