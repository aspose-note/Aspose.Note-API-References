...
description: Aspose.Note.OutlineElement 수업. 는 OutlineElement를 나타냅니다.
type: docs
weight: 460
url: /ko/net/aspose.note/outlineelement/
---
## OutlineElement class

는 OutlineElement를 나타냅니다.
...
| 이름 | 설명 |
| --- | --- |
| [OutlineElement](outlineelement/#constructor)() | 의 새 인스턴스를 초기화합니다.`OutlineElement` 클래스. |

## 속성

| 이름 | 설명 |
| --- | --- |
| [CreationTime](../../aspose.note/outlineelement/creationtime/) { get; set; } | 생성 시간을 가져오거나 설정합니다. |
...
| [LastModifiedTime](../../aspose.note/outlineelement/lastmodifiedtime/) { get; set; } | 마지막 수정 시간을 가져오거나 설정합니다. |
...
| [NumberList](../../aspose.note/outlineelement/numberlist/) { get; set; } | 번호 매기기 목록 헤더의 스타일을 가져오거나 설정합니다. |
...
| 이름 | 설명 |
| --- | --- |
| override [Accept](../../aspose.note/outlineelement/accept/)(DocumentVisitor) | 노드의 방문자를 수락합니다. |
