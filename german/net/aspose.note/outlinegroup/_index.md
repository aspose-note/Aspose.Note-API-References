...
description: Repräsentiert eine OutlineGroup.
type: docs
weight: 450
url: /de/net/aspose.note/outlinegroup/
---
## OutlineGroup class

Repräsentiert eine OutlineGroup.
...
| Name | Beschreibung |
| --- | --- |
| [OutlineGroup](outlinegroup#constructor)() | Initialisiert eine neue Instanz von[`OutlineGroup`](../outlinegroup) Klasse. |
...
| [IndentPosition](../../aspose.note/outlinegroup/indentposition) { get; set; } | Ruft die Einzugsposition ab oder legt sie fest. |
...
| Name | Beschreibung |
| --- | --- |
| override [Accept](../../aspose.note/outlinegroup/accept)(DocumentVisitor) | Akzeptiert den Besucher des Knotens. |
