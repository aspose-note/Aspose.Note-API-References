...
description: Aspose.Note.TableColumn klas. Repräsentiert eine Tabellenspalte.
type: docs
weight: 920
url: /de/net/aspose.note/tablecolumn/
---
## TableColumn class

Repräsentiert eine Tabellenspalte.
...
| Name | Beschreibung |
| --- | --- |
| [LockedWidth](../../aspose.note/tablecolumn/lockedwidth/) { get; set; } | Ruft einen Wert ab oder legt einen Wert fest, der angibt, ob eine Tabellenspalte eine gesperrte Breite hat und die Größe nicht automatisch an den Tabelleninhalt angepasst wird. Standardmäßig ist die Spaltenbreite nicht gesperrt. |
| [Width](../../aspose.note/tablecolumn/width/) { get; set; } | Ruft die Breite ab oder legt sie fest. |
