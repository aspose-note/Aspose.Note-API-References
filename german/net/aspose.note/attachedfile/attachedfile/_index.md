...
description: Initialisiert eine neue Instanz vonAttachedFileaspose.note/attachedfile Klasse.
type: docs
weight: 10
...
Initialisiert eine neue Instanz von[`AttachedFile`](../../attachedfile) Klasse.
...
| --- | --- | --- |
| path | String | Eine Zeichenfolge, die den Pfad zu der Datei enthält, aus der die erstellt werden soll[`AttachedFile`](../../attachedfile) . |
