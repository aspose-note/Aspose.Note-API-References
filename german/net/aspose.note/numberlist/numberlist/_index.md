...
description: Initialisiert eine neue Instanz vonNumberListaspose.note/numberlist class. Diese Instanz repräsentiert eine Liste mit Aufzählungszeichen.
type: docs
weight: 10
...
Initialisiert eine neue Instanz von[`NumberList`](../../numberlist) class. Diese Instanz repräsentiert eine Liste mit Aufzählungszeichen.
...
Initialisiert eine neue Instanz von[`NumberList`](../../numberlist)class. Diese Instanz repräsentiert eine nummerierte Liste.
