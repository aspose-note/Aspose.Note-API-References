...
description: Repräsentiert die nummerierte oder Aufzählungsliste.
type: docs
weight: 420
...
| Name | Beschreibung |
| --- | --- |
| [NumberList](numberlist#constructor_1)(string, string, int) | Initialisiert eine neue Instanz von[`NumberList`](../numberlist) class. Diese Instanz repräsentiert eine Liste mit Aufzählungszeichen. |
| [NumberList](numberlist#constructor)(string, NumberFormat, string, int) | Initialisiert eine neue Instanz von[`NumberList`](../numberlist)class. Diese Instanz repräsentiert eine nummerierte Liste. |
