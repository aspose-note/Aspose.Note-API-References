...
description: Gibt die Abmessungen der Ränder eines Knotens an.
type: docs
weight: 310
...
| Name | Beschreibung |
| --- | --- |
| [Margins](margins)(float, float, float, float) | Initialisiert eine neue Instanz von[`Margins`](../margins) struct mit den angegebenen linken, rechten, oberen und unteren Rändern. |
