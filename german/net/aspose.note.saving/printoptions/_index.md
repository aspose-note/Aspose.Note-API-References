...
description: Optionen zum Drucken eines Dokuments.
type: docs
weight: 830
...
| Name | Beschreibung |
| --- | --- |
| [DocumentName](../../aspose.note.saving/printoptions/documentname) { get; set; } | Ruft den beim Drucken des Dokuments anzuzeigenden Dokumentnamen ab oder legt ihn fest (z. B. in einem Druckstatusdialogfeld oder einer Druckerwarteschlange). |
