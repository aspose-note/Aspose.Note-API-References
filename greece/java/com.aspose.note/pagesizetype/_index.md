...
description: "Καθορίζει το μέγεθος του τύπου κόμβου σελίδας."
type: docs
weight: 73
url: /el/java/com.aspose.note/pagesizetype/
---
...
| [IndexCard](#IndexCard) | Κάρτα ευρετηρίου (3" x 5"). |
| [JISB4](#JISB4) | JIS B4 (257mm x 364mm). |
| [JISB5](#JISB5) | JIS B5 (182mm x 257mm). |
| [JISB6](#JISB6) | JIS B6 (128mm x 182mm). |
| [JapanesePostcard](#JapanesePostcard) | Ιαπωνική κάρτα ταχυδρόμου (100mm x 148mm). |
| [SizeByContent](#SizeByContent) | Η σελίδα δεν έχει σταθερό μέγεθος. |
| [USLegal](#USLegal) | Η.Π.Α. |
| [USStatement](#USStatement) | Η.Π.Α. |
...
Ιαπωνική κάρτα ταχυδρόμου (100mm x 148mm).
...
Η σελίδα δεν έχει σταθερό μέγεθος. Προσαρμόζεται αυτόματα ώστε να χωρά όλο το περιεχόμενο μέσα της.
