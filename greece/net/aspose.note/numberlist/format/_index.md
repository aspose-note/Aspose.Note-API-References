...
description: NumberList ιδιοκτησία. Λαμβάνει ή ορίζει τη μορφή της κεφαλίδας γραμμής. Για λίστες με κουκκίδες αντιπροσωπεύει ένα σύμβολο κουκκίδας.
type: docs
weight: 50
url: /el/net/aspose.note/numberlist/format/
---
