...
description: Aspose.Note.TableColumn τάξη. Αντιπροσωπεύει μια στήλη πίνακα.
type: docs
weight: 920
url: /el/net/aspose.note/tablecolumn/
---
## TableColumn class
...
| Ονομα | Περιγραφή |
| --- | --- |
| [TableColumn](tablecolumn/)() | Ο προεπιλεγμένος κατασκευαστής. |

## Ιδιότητες

| Ονομα | Περιγραφή |
| --- | --- |
| [LockedWidth](../../aspose.note/tablecolumn/lockedwidth/) { get; set; } | Λαμβάνει ή ορίζει μια τιμή που υποδεικνύει εάν μια στήλη πίνακα έχει κλειδωμένο πλάτος και δεν αλλάζει το μέγεθος αυτόματα ώστε να ταιριάζει στο περιεχόμενο του πίνακα. Από προεπιλογή, το πλάτος της στήλης δεν είναι κλειδωμένο. |
| [Width](../../aspose.note/tablecolumn/width/) { get; set; } | Λαμβάνει ή ορίζει το πλάτος. |
