...
description: RevisionSummary ιδιοκτησία. Λαμβάνει ή ορίζει τον πιο πρόσφατο συγγραφέα.
type: docs
weight: 20
url: /el/net/aspose.note/revisionsummary/authormostrecent/
---
## RevisionSummary.AuthorMostRecent property

Λαμβάνει ή ορίζει τον πιο πρόσφατο συγγραφέα.
