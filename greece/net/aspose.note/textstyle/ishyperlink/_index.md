...
description: Ιδιότητα TextStyle. Παρωχημένο από την έκδοση 22.5. Χρησιμοποιήστε αντ’ αυτού το HyperlinkAddress.
type: docs
weight: 80
...
Παρωχημένο από την έκδοση 22.5. Χρησιμοποιήστε αντ’ αυτού το `HyperlinkAddress`.
