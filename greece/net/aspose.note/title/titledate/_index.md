...
description: Title ιδιοκτησία. Λαμβάνει ή ορίζει μια παράσταση συμβολοσειράς της ημερομηνίας στον τίτλο.
type: docs
weight: 50
url: /el/net/aspose.note/title/titledate/
---
## Title.TitleDate property

Λαμβάνει ή ορίζει μια παράσταση συμβολοσειράς της ημερομηνίας στον τίτλο.
