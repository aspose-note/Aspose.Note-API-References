...
description: Title ιδιοκτησία. Λαμβάνει ή ορίζει μια παράσταση συμβολοσειράς της ώρας στον τίτλο.
type: docs
weight: 70
url: /el/net/aspose.note/title/titletime/
---
## Title.TitleTime property

Λαμβάνει ή ορίζει μια παράσταση συμβολοσειράς της ώρας στον τίτλο.
