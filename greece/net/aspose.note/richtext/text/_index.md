...
description: RichText ιδιοκτησία. Λαμβάνει ή ορίζει το κείμενο. Η συμβολοσειρά ΔΕΝ ΠΡΕΠΕΙ να περιέχει χαρακτήρες της τιμής 10 τροφοδοσία γραμμής.
type: docs
weight: 100
url: /el/net/aspose.note/richtext/text/
---
## RichText.Text property

Λαμβάνει ή ορίζει το κείμενο. Η συμβολοσειρά ΔΕΝ ΠΡΕΠΕΙ να περιέχει χαρακτήρες της τιμής 10 (τροφοδοσία γραμμής).
