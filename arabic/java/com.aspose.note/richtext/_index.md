...
| المنشئ | الوصف |
| --- | --- |
| [RichText()](#RichText--) | يُنشئ مثيلًا جديدًا من الفئة [RichText](../../com.aspose.note/richtext). |
## الطرق
...
| [clear()](#clear--) | يمسح محتوى هذا المثيل. |
...
| [getTags()](#getTags--) | يحصل على قائمة بجميع العلامات في الفقرة. |
...
| [indexOf(char value, int startIndex, int count)](#indexOf-char-int-int-) | يعيد الفهرس الصفري للظهور الأول للحرف المحدد في هذا المثيل. |
| [indexOf(String value)](#indexOf-java.lang.String-) | يعيد الفهرس الصفري للظهور الأول للسلسلة المحددة في هذا المثيل. |
| [indexOf(String value, int startIndex)](#indexOf-java.lang.String-int-) | يعيد الفهرس الصفري للظهور الأول للسلسلة المحددة في هذا المثيل. |
| [indexOf(String value, int startIndex, int count)](#indexOf-java.lang.String-int-int-) | يعيد الفهرس الصفري للظهور الأول للسلسلة المحددة في هذا المثيل. |
| [indexOf(String value, int startIndex, int count, short comparisonType)](#indexOf-java.lang.String-int-int-short-) | يعيد الفهرس الصفري للظهور الأول للسلسلة المحددة في المثيل الحالي. |
| [indexOf(String value, short comparisonType)](#indexOf-java.lang.String-short-) | يعيد الفهرس الصفري للظهور الأول للسلسلة المحددة في المثيل الحالي. |
| [indexOf_Rename_Namesake(String value, int startIndex, short comparisonType)](#indexOf-Rename-Namesake-java.lang.String-int-short-) | يعيد الفهرس الصفري للظهور الأول للسلسلة المحددة في المثيل الحالي. |
| [insert(int startIndex, String value)](#insert-int-java.lang.String-) | يدرج سلسلة محددة في موضع فهرس محدد في هذا المثيل. |
| [insert(int startIndex, String value, TextStyle style)](#insert-int-java.lang.String-com.aspose.note.TextStyle-) | يدرج سلسلة محددة مع نمط محدد في موضع فهرس محدد في هذا المثيل. |
| [iterator()](#iterator--) |  |
| [remove(int startIndex)](#remove-int-) | يزيل جميع الأحرف في المثيل الحالي، بدءًا من موضع محدد ومتابعة حتى الموضع الأخير. |
| [remove(int startIndex, int count)](#remove-int-int-) | يزيل عددًا محددًا من الأحرف في المثيل الحالي بدءًا من موضع محدد. |
| [replace(char oldChar, char newChar)](#replace-char-char-) | يستبدل جميع ظهورات حرف Unicode محدد في هذا المثيل بحرف Unicode آخر محدد. |
| [replace(String oldValue, String newValue)](#replace-java.lang.String-java.lang.String-) | يستبدل جميع ظهورات سلسلة محددة في المثيل الحالي بسلسلة أخرى محددة. |
| [replace(String oldValue, String newValue, TextStyle style)](#replace-java.lang.String-java.lang.String-com.aspose.note.TextStyle-) | يستبدل جميع ظهورات سلسلة محددة في المثيل الحالي بسلسلة أخرى محددة بنمط محدد. |
...
| [trim()](#trim--) | يزيل جميع أحرف المسافة البيضاء في البداية والنهاية. |
| [trim(char trimChar)](#trim-char-) | يزيل جميع حالات الحرف في البداية والنهاية. |
| [trim(char[] trimChars)](#trim-char...-) | يزيل جميع حدوث مجموعة الأحرف المحددة في مصفوفة في البداية والنهاية. |
| [trimEnd()](#trimEnd--) | يزيل جميع أحرف المسافة البيضاء في النهاية. |
| [trimEnd(char trimChar)](#trimEnd-char-) | يزيل جميع حدوث الحرف في النهاية. |
| [trimEnd(char[] trimChars)](#trimEnd-char...-) | يزيل جميع حدوث مجموعة الأحرف المحددة في مصفوفة في النهاية. |
| [trimStart()](#trimStart--) | يزيل جميع أحرف المسافة البيضاء في البداية. |
| [trimStart(char trimChar)](#trimStart-char-) | يزيل جميع حدوث الحرف المحدد في البداية. |
| [trimStart(char[] trimChars)](#trimStart-char...-) | يزيل جميع حدوث مجموعة الأحرف المحددة في مصفوفة في البداية. |
### RichText() {#RichText--}
```
public RichText()
```
...
يُنشئ مثيلًا جديدًا من الفئة [RichText](../../com.aspose.note/richtext).
...
يحصل على النص. يجب ألا يحتوي السلسلة على أي أحرف ذات القيمة 10 (سطر جديد).
...
يرجع الفهرس الصفري للحدوث الأول للحرف Unicode المحدد في هذه السلسلة. يبدأ البحث من موضع حرف محدد.
...
يرجع الفهرس الصفري للحدوث الأول للحرف المحدد في هذه الحالة. يبدأ البحث من موضع حرف محدد ويفحص عددًا محددًا من مواضع الأحرف.
...
يعيد الفهرس الصفري للظهور الأول للسلسلة المحددة في هذا المثيل.
...
يعيد الفهرس الصفري للظهور الأول للسلسلة المحددة في المثيل الحالي.
...
يعيد الفهرس الصفري للظهور الأول للسلسلة المحددة في الحالة الحالية. يُحدِّد معامل نوع البحث الذي سيُستخدم للسلسلة المحددة.
...
يعيد الفهرس الصفري للظهور الأول للسلسلة المحددة في الحالة الحالية. تُحدِّد المعاملات موضع بدء البحث في السلسلة الحالية ونوع البحث الذي سيُستخدم للسلسلة المحددة.
...
يدرج سلسلة محددة في موضع فهرس محدد في هذا المثيل.

**Parameters:**
| معامل | نوع | الوصف |
| --- | --- | --- |
| startIndex | int | موضع البداية. |
| القيمة | java.lang.String | القيمة. |
...
يدرج سلسلة محددة مع نمط محدد في موضع فهرس محدد في هذا المثيل.
...
يزيل جميع الأحرف في المثيل الحالي، بدءًا من موضع محدد ومتابعة حتى الموضع الأخير.
...
يزيل عددًا محددًا من الأحرف في المثيل الحالي بدءًا من موضع محدد.
...
يستبدل جميع ظهورات حرف Unicode محدد في هذا المثيل بحرف Unicode آخر محدد.
...
يستبدل جميع ظهورات سلسلة محددة في المثيل الحالي بسلسلة أخرى محددة.
...
يستبدل جميع ظهورات سلسلة محددة في المثيل الحالي بسلسلة أخرى محددة بنمط محدد.
...
يضبط نمط الفقرة. تُستخدم هذه الإعدادات إذا لم يكن هناك كائن TextStyle مطابق في مجموعة [getStyles](../../com.aspose.note/richtext\#getStyles) أو إذا لم يُحدِّد هذا الكائن الإعداد المطلوب.
...
يضبط النص. يجب ألا يحتوي السلسلة على أي أحرف ذات القيمة 10 (سطر جديد).
...
يزيل جميع أحرف المسافة البيضاء في البداية والنهاية.
...
يزيل جميع حدوث مجموعة الأحرف المحددة في مصفوفة في البداية والنهاية.

**Parameters:**
| معامل | نوع | الوصف |
| --- | --- | --- |
| trimChars | char[] | حروف القص. |
...
يزيل جميع أحرف المسافة البيضاء في النهاية.
...
يزيل جميع حدوث الحرف في النهاية.
...
يزيل جميع حدوث مجموعة الأحرف المحددة في مصفوفة في النهاية.
...
يزيل جميع أحرف المسافة البيضاء في البداية.
...
يزيل جميع حدوث الحرف المحدد في البداية.
...
يزيل جميع حدوث مجموعة الأحرف المحددة في مصفوفة في البداية.
