...
type: docs
weight: 78
url: /ar/java/com.aspose.note/printoptions/
---
...
يحصل أو يضبط اسم المستند للعرض (على سبيل المثال، في مربع حوار حالة الطباعة أو طابور الطابعة) أثناء طباعة المستند.
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| القيمة | javax.print.attribute.AttributeSet |  |
