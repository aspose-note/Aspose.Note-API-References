...
description: "الفئة Aspose.Note.TableRow. تمثل صفًا في الجدول"
type: docs
weight: 1010
...
| الاسم | الوصف |
| --- | --- |
| [TableRow](tablerow/)() | الباني الافتراضي. |
...
| [LastModifiedTime](../../aspose.note/tablerow/lastmodifiedtime/) { get; set; } | يحصل أو يعيّن وقت التعديل الأخير. |
