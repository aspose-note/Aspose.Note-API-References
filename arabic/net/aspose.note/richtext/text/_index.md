...
description: الحصول على النص أو تعيينه. يجب ألا تحتوي السلسلة على أي أحرف بالقيمة 10 تغذية السطر .
type: docs
weight: 100
...
الحصول على النص أو تعيينه. يجب ألا تحتوي السلسلة على أي أحرف بالقيمة 10 (تغذية السطر) .
