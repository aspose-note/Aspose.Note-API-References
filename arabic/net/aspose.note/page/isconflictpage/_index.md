...
description: "خاصية Page. تحصل أو تعيين قيمة تشير إلى ما إذا كانت هذه الصفحة صفحة تعارض"
type: docs
weight: 50
...
في هذا الإصدار يتم حل التعارضات لصالح تغييرات المستخدم الأول. لذا إذا كان المستند يحتوي على صفحات تعارض فستظهر في السجل ولكن سيتم تخطيها عند الحفظ. يمكن إعادة تعيين هذه العلامة لحفظ هذه الصفحات في السجل كصفحات عادية.

يمكن العثور على مثال مفصل لتعامل مع صفحة التعارض في الوثائق عبر الإنترنت.
