...
description: NumberList ملكية. الحصول على تنسيق عنوان السطر أو تحديده. بالنسبة للقوائم النقطية  يمثل رمز التعداد النقطي.
type: docs
weight: 50
...
الحصول على تنسيق عنوان السطر أو تحديده. بالنسبة للقوائم النقطية ، يمثل رمز التعداد النقطي.
