...
description: يتم استخدام إعدادات نمط النص في حالة عدم وجود كائن TextStyle مطابق فيStyles مجموعة إما أن هذا الكائن لا يحدد الإعداد المطلوب.
type: docs
weight: 490
...
| اسم | وصف |
| --- | --- |
| [ParagraphStyle](paragraphstyle)() | يقوم بتهيئة مثيل جديد لملف[`ParagraphStyle`](../paragraphstyle) فئة . |
