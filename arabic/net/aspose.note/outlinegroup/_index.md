...
| اسم | وصف |
| --- | --- |
| [OutlineGroup](outlinegroup#constructor)() | يقوم بتهيئة مثيل جديد لملف[`OutlineGroup`](../outlinegroup) فئة . |
...
| [IndentPosition](../../aspose.note/outlinegroup/indentposition) { get; set; } | الحصول على موضع المسافة البادئة أو تعيينه . |
