...
type: docs
weight: 360
url: /ar/net/aspose.note/inkword/
---
## InkWord class

يمثل عقدة حبر تحتوي على نص مكتوب يدويًا.

```csharp
public sealed class InkWord : InkNode, IOutlineElementChildNode
```
...
| الاسم | الوصف |
| --- | --- |
| override [Accept](../../aspose.note/inkword/accept/)(DocumentVisitor) | يقبل زائر العقدة. |
