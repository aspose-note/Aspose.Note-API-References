...
| [ReservedWidth](../../aspose.note/outline/reservedwidth/) { get; set; } | يحصل أو يعيّن العرض المحجوز. |
| [VerticalOffset](../../aspose.note/outline/verticaloffset/) { get; set; } | يحصل أو يضبط الإزاحة العمودية. |
