...
description: يحدد رمز العلامة أو أيقونة المهمة.
type: docs
weight: 910
...
| GreenCheckBox1 | `48` | أيقونة خانة اختيار خضراء 1 . |
...
| YellowRightArrow | `80` | رمز السهم الأيمن الأصفر. |
...
| YellowXWithDots | `87` | علامة "X" صفراء مع أيقونة من النقاط. |
| YellowX | `88` | رمز "X" أصفر . |
| FollowUpTodayFlag | `89` | رمز علامة المتابعة اليوم . |
| FollowUpTomorrowFlag | `90` | متابعة رمز علم الغد . |
...
| BlueFlagCheckBox | `97` | رمز خانة الاختيار العلم الأزرق. |
...
| PaperClip | `112` | أيقونة مشبك الورق . |
...
| OpenBook | `132` | افتح أيقونة الكتاب. |
...
| BlueRightArrowCheckBoxEmpty | `151` | خانة اختيار السهم الأيمن الأزرق رمز فارغ. |
...
| GreenCheckBoxEmpty | `156` | رمز خانة اختيار أخضر فارغ. |
| GreenExclamationCheckBoxEmpty | `157` | رمز خانة اختيار علامة تعجب خضراء فارغة. |
