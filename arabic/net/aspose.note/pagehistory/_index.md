...
| الاسم | الوصف |
| --- | --- |
| [Add](../../aspose.note/pagehistory/add/)(Page) | يضيف إصدار الصفحة إلى نهاية `PageHistory`. |
| [AddRange](../../aspose.note/pagehistory/addrange/)(IEnumerable&lt;Page&gt;) | يضيف إصدارات الصفحة إلى نهاية `PageHistory`. |
...
| [RemoveRange](../../aspose.note/pagehistory/removerange/)(int, int) | يزيل نطاقًا من إصدارات الصفحة من `PageHistory`. |
