...
description: يقوم بتهيئة مثيل جديد لملفAttachedFileaspose.note/attachedfile فئة .
type: docs
weight: 10
...
يقوم بتهيئة مثيل جديد لملف[`AttachedFile`](../../attachedfile) فئة .
...
| معامل | يكتب | وصف |
| --- | --- | --- |
| path | String | سلسلة تحتوي على مسار الملف الذي سيتم إنشاء ملف[`AttachedFile`](../../attachedfile) . |
