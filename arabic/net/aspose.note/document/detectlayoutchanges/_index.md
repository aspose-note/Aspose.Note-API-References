...
description: "طريقة Document. تكتشف جميع التغييرات التي تم إجراؤها على تخطيط المستند منذ استدعاء DetectLayoutChanges السابق. في حالة تعيين AutomaticLayoutChangesDetectionEnabled إلى true يتم استخدامها تلقائيًا في بداية تصدير المستند"
type: docs
weight: 90
