...
description: "الفئة Aspose.Note.Saving.NotebookSaveOptions1TDocumentSaveOptions. فئة أساسية مجردة تمثل خيارات حفظ الدفتر لتنسيق معين وتوفر خيارات حفظ مشتركة لجميع العقد الفرعية للمستند."
type: docs
weight: 880
...
فئة أساسية مجردة تمثل خيارات حفظ الدفتر لتنسيق معين وتوفر خيارات حفظ مشتركة لجميع عقد المستند الفرعية.
...
| override [SaveFormat](../../aspose.note.saving/notebooksaveoptions-1/saveformat/) { get; } | يحصل على التنسيق الذي يُحفظ به الدفتر. |
