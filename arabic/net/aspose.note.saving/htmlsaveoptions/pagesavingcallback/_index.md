...
description: "خاصية HtmlSaveOptions. يحصل أو يضبط رد النداء الذي يُستدعى لإنشاء مورد لتخزين الصفحة"
type: docs
weight: 110
...
يحصل أو يضبط الدالة الراجعة التي تُستدعى لإنشاء مورد لتخزين الصفحة.
