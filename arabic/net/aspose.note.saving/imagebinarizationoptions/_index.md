...
description: خيارات لترميز الصورة بالترميز .
type: docs
weight: 690
...
| [BinarizationThreshold](../../aspose.note.saving/imagebinarizationoptions/binarizationthreshold) { get; set; } | الحصول على القيمة الحدية أو تعيينها لطريقة ترميز العتبة الثنائية الثابتة . القيمة الافتراضية هي 128. |
