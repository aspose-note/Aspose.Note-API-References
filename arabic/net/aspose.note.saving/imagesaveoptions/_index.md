...
description: يسمح بتحديد خيارات إضافية عند عرض صفحات المستند على الصور.
type: docs
weight: 700
...
| اسم | وصف |
| --- | --- |
| [ImageSaveOptions](imagesaveoptions)(SaveFormat) | يقوم بتهيئة مثيل جديد لملف[`ImageSaveOptions`](../imagesaveoptions) فئة . |
...
| [Quality](../../aspose.note.saving/imagesaveoptions/quality) { get; set; } | الحصول على أو تعيين قيمة تحدد جودة الصورة المحفوظة. يتم تمرير هذه القيمة إلى برنامج الترميز مثل System.Drawing.Imaging.Encoder.Quality المعلمة. |
