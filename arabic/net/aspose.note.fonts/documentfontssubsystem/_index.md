...
description: تنفيذ بسيط لـ Aspose.Note.Fonts.FontsSubsystem. يستردFontFamily كائن من OS.
type: docs
weight: 100
...
| اسم | وصف |
| --- | --- |
| [DocumentFontsSubsystem](documentfontssubsystem#constructor)(Dictionary&lt;string, string&gt;) | يقوم بتهيئة مثيل جديد لملف[`DocumentFontsSubsystem`](../documentfontssubsystem) فئة . |
| [DocumentFontsSubsystem](documentfontssubsystem#constructor_1)(Stream, Dictionary&lt;string, string&gt;) | يقوم بتهيئة مثيل جديد لملف[`DocumentFontsSubsystem`](../documentfontssubsystem) فئة . |
| [DocumentFontsSubsystem](documentfontssubsystem#constructor_2)(string, Dictionary&lt;string, string&gt;) | يقوم بتهيئة مثيل جديد لملف[`DocumentFontsSubsystem`](../documentfontssubsystem) فئة . |
