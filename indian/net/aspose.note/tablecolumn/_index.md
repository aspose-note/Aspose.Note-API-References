...
description: Aspose.Note.TableColumn कक्ष. तलक स्तंभ क प्रतनधत्व करत है
type: docs
weight: 920
url: /hi/net/aspose.note/tablecolumn/
---
## TableColumn class

तालिका स्तंभ का प्रतिनिधित्व करता है।
...
| नाम | विवरण |
| --- | --- |
| [TableColumn](tablecolumn/)() | डिफ़ॉल्ट कंस्ट्रक्टर। |

## गुण

| नाम | विवरण |
| --- | --- |
| [LockedWidth](../../aspose.note/tablecolumn/lockedwidth/) { get; set; } | एक मान प्राप्त करता है या सेट करता है जो इंगित करता है कि तालिका कॉलम में चौड़ाई बंद है और तालिका सामग्री को फिट करने के लिए स्वचालित रूप से आकार नहीं बदलता है। डिफ़ॉल्ट रूप से, कॉलम चौड़ाई लॉक नहीं होती है। |
| [Width](../../aspose.note/tablecolumn/width/) { get; set; } | चौड़ाई प्राप्त या सेट करता है। |
