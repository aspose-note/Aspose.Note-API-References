...
description: Aspose.Note.Saving.ImageSaveOptions 班级. 允许在将文档页面呈现为图像时指定其他选项
type: docs
weight: 720
...
| 姓名 | 描述 |
| --- | --- |
| [ImageSaveOptions](imagesaveoptions/)(SaveFormat) | 初始化一个新的实例`ImageSaveOptions`类. |
...
| [Quality](../../aspose.note.saving/imagesaveoptions/quality/) { get; set; } | 获取或设置确定已保存图像质量的值。 此值作为 System.Drawing.Imaging.Encoder.Quality 参数传递给编解码器。 |
