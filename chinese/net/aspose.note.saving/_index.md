...
| [NotebookPdfSaveOptions](./notebookpdfsaveoptions/) | 允许在将笔记本页面渲染为 PDF 时指定其他选项。 |
| [NotebookSaveOptions](./notebooksaveoptions/) | 一个抽象基类，表示特定格式的笔记本保存选项。 |
