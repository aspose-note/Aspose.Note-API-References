...
| 命名空间 | 描述 |
| --- | --- |
| [Aspose.Note](./aspose.note) | 的Note命名空间包含代表文档结构的类。 |
| [Aspose.Note.Fonts](./aspose.note.fonts) | 的Fonts命名空间包含的类提供了通过字体环境对文档进行操作的功能。 |
| [Aspose.Note.Importing](./aspose.note.importing) | 的Importing命名空间包含提供 api 以从 PDF 格式的文档中导入内容的类。 |
