...
| 姓名 | 描述 |
| --- | --- |
| static [InchToPoint](../../aspose.note/displayunitsconverter/inchtopoint)(float) | 将英寸转换为磅。 |
| static [MillimeterToInch](../../aspose.note/displayunitsconverter/millimetertoinch)(float) | 将毫米转换为英寸。 |
| static [MillimeterToPoint](../../aspose.note/displayunitsconverter/millimetertopoint)(float) | 将毫米转换为磅。 |
| static [PixelToPoint](../../aspose.note/displayunitsconverter/pixeltopoint)(int, float) | 将像素转换为指定像素分辨率的点。 |
