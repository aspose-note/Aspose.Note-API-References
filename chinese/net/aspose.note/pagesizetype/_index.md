...
| 名称 | 值 | 描述 |
| --- | --- | --- |
| SizeByContent | `0` | 页面没有固定大小。它会自动调整大小以容纳其中的所有内容。 |
| USStatement | `1` | 美国信纸 (5.5" x 8.5"). |
| ANSILetter | `2` | ANSI 信纸 (8.5" x 11"). |
| ANSITabloid | `3` | ANSI 小报 (11" x 17"). |
| USLegal | `4` | 美国法律纸 (8.5" x 14"). |
