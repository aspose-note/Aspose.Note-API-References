...
description: 添加子文档节点 从文件中打开现有 OneNote 文档
type: docs
weight: 120
...
添加子文档节点。 从文件中打开现有 OneNote 文档。允许指定其他加载选项。
...
添加子文档节点。 从流中打开现有 OneNote 文档。允许指定其他加载选项。
