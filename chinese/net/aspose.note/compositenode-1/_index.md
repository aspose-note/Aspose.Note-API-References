...
| virtual [AppendChildFirst&lt;T1&gt;](../../aspose.note/compositenode`1/appendchildfirst)(T1) | 将该节点添加到该节点的子节点列表的前面。 |
...
| [GetEnumerator](../../aspose.note/compositenode`1/getenumerator)() | 返回一个遍历子节点的枚举器[`CompositeNode`](../compositenode-1). |
