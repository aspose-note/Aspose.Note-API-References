...
| static [CreateGreenTriangle](../../aspose.note/notetag/creategreentriangle)(string) | 创建一个带有 GreenTriangle 图标和指定标签的新笔记标签。 |
...
| static [CreatePlane](../../aspose.note/notetag/createplane)(string) | 创建一个带有平面图标和指定标签的新注释标签。 |
...
| static [CreateSunflower](../../aspose.note/notetag/createsunflower)(string) | 创建一个带有向日葵图标和指定标签的新笔记标签。 |
