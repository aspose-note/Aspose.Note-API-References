...
description: "表示标准 ApsPath 的包装器，扩展了一些绘图行为。"
type: docs
weight: 28
url: /zh/java/com.aspose.note/extendedapspath/
---
...
表示标准 ApsPath 的包装器，扩展了一些绘图行为。
## 构造函数

| 构造函数 | 描述 |
| --- | --- |
| [ExtendedApsPath(ApsPath internalApsPath)](#ExtendedApsPath-com.aspose.foundation.rendering.ApsPath-) | 初始化 `ExtendedApsPath` 类的新实例。 |
## 方法
...
初始化 `ExtendedApsPath` 类的新实例。

**Parameters:**
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| internalApsPath | com.aspose.foundation.rendering.ApsPath | aps 路径。 |
