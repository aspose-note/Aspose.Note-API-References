...
type: docs
weight: 78
url: /zh/java/com.aspose.note/printoptions/
---
...
| 构造函数 | 描述 |
| --- | --- |
| [PrintOptions()](#PrintOptions--) | 初始化 `PrintOptions` 类的新实例。 |
## 方法
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| 值 | javax.print.attribute.AttributeSet |  |
