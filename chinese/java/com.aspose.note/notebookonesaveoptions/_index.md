...
description: "在将笔记本保存为 OneNote 格式时允许指定额外选项。"
type: docs
weight: 59
url: /zh/java/com.aspose.note/notebookonesaveoptions/
---
...
在将笔记本保存为 OneNote 格式时允许指定额外选项。
## 构造函数

| 构造函数 | 描述 |
| --- | --- |
| [NotebookOneSaveOptions()](#NotebookOneSaveOptions--) | 初始化 `NotebookOneSaveOptions` 类的新实例。 |
...
初始化 `NotebookOneSaveOptions` 类的新实例。
