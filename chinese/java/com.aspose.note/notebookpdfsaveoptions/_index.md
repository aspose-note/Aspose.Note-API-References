...
description: "在将笔记本页面渲染为 PDF 时允许指定额外选项。"
type: docs
weight: 60
url: /zh/java/com.aspose.note/notebookpdfsaveoptions/
---
...
在将笔记本页面渲染为 PDF 时允许指定额外选项。
## 构造函数

| 构造函数 | 描述 |
| --- | --- |
| [NotebookPdfSaveOptions()](#NotebookPdfSaveOptions--) | 初始化 `NotebookPdfSaveOptions` 类的新实例。 |
...
初始化 `NotebookPdfSaveOptions` 类的新实例。
