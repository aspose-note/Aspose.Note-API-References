...
description: La classe fournissant lapi pour importer le contenu de documents au format PDF. Lapi permet dimporter à partir dun document PDF situé soit dans un fichier soit dans un flux en utilisant les options spécifiées. Les options dimportation sont passées en utilisantPdfImportOptions./pdfimportoptions .
type: docs
weight: 260
