...
description: Implémentez cette interface si vous souhaitez contrôler la manière dont Aspose.Note enregistre les polices lors de lenregistrement dun document au format HTML.
type: docs
weight: 610
