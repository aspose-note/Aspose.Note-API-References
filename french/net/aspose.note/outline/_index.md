...
description: Représente un contour.
type: docs
weight: 430
...
| Nom | La description |
| --- | --- |
| [Outline](outline#constructor)() | Initialise une nouvelle instance du[`Outline`](../outline) classe. |
...
| [IndentPosition](../../aspose.note/outline/indentposition) { get; set; } | Obtient ou définit la position du retrait. |
