...
description: RichText propriété. Obtient ou définit le style de paragraphe. Ces paramètres sont utilisés sil ny a pas dobjet TextStyle correspondant dansStyles collection soit cet objet ne spécifie pas un paramètre nécessaire.
type: docs
weight: 60
