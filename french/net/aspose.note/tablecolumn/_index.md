...
description: Aspose.Note.TableColumn classe. Représente une colonne de tableau.
type: docs
weight: 920
url: /fr/net/aspose.note/tablecolumn/
---
## TableColumn class

Représente une colonne de tableau.
...
| Nom | La description |
| --- | --- |
| [LockedWidth](../../aspose.note/tablecolumn/lockedwidth/) { get; set; } | Obtient ou définit une valeur indiquant si une colonne de tableau a une largeur verrouillée et ne se redimensionne pas automatiquement pour s'adapter au contenu du tableau. Par défaut, la largeur de colonne n'est pas verrouillée. |
| [Width](../../aspose.note/tablecolumn/width/) { get; set; } | Obtient ou définit la largeur. |
