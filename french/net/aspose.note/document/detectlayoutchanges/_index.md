...
description: Détecte toutes les modifications apportées à la mise en page du document depuis la précédenteDetectLayoutChangesaspose.note/document/detectlayoutchanges appeler. Au cas oùAutomaticLayoutChangesDetectionEnabledaspose.note/document/automaticlayoutchangesdetectionenabled défini sur vrai utilisé automatiquement au début de lexportation du document.
type: docs
weight: 90
