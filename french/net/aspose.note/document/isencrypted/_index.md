...
description: Vérifie si un document dun flux est crypté. Pour le vérifier nous devons charger complètement ce document. Cette méthode peut donc entraîner une baisse des performances.
type: docs
weight: 150
