...
description: Initialise une nouvelle instance duImageaspose.note/image classe.
type: docs
weight: 10
...
| --- | --- | --- |
| path | String | Une chaîne contenant le chemin d'accès au fichier à partir duquel créer le[`Image`](../../image) . |
