...
description: Image propriété. Obtient ou définit la largeur. Il sagit de la largeur réelle de limage dans le document MS OneNote.
type: docs
weight: 180
url: /fr/net/aspose.note/image/width/
---
## Image.Width property

Obtient ou définit la largeur. Il s'agit de la largeur réelle de l'image dans le document MS OneNote.
