...
description: Obtient ou définit un mot de passe pour le contenu du document chiffré. La valeur est ignorée si le document nest pas protégé par un mot de passe.
type: docs
weight: 20
