...
| CommentBubble | `24` | Icône de bulle de commentaire. |
...
| GreenStar | `61` | Icône étoile verte. |
...
| RedFlagCheckBox | `98` | Icône de case à cocher drapeau rouge. |
...
| Research | `135` | Icône de recherche (livres avec une loupe). |
