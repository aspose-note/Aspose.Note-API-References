...
description: Déplace lobjet complet vers la page suivante au cas où il ne rentre pas dans la page dorigine.
type: docs
weight: 720
...
| Nom | La description |
| --- | --- |
| [KeepSolidObjectsAlgorithm](keepsolidobjectsalgorithm#constructor)() | Initialise une nouvelle instance du[`KeepSolidObjectsAlgorithm`](../keepsolidobjectsalgorithm) classe utilisant la limite de hauteur par défaut de la partie clonée. |
| [KeepSolidObjectsAlgorithm](keepsolidobjectsalgorithm#constructor_1)(float) | Initialise une nouvelle instance du[`KeepSolidObjectsAlgorithm`](../keepsolidobjectsalgorithm) classe utilisant la limite de hauteur spécifique de la partie clonée. |
