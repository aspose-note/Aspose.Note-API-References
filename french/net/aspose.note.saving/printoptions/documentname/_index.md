...
description: Obtient ou définit le nom du document à afficher par exemple dans une boîte de dialogue détat dimpression ou une file dattente dimpression lors de limpression du document.
type: docs
weight: 20
