...
description: HtmlSaveOptions propriété. Obtient ou définit la manière dont le CSS est exporté.
type: docs
weight: 50
url: /fr/net/aspose.note.saving/htmlsaveoptions/exportcss/
---
## HtmlSaveOptions.ExportCss property

Obtient ou définit la manière dont le CSS est exporté.
