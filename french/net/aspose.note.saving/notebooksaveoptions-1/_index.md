...
description: Une classe de base abstraite qui représente les options denregistrement du bloc-notes pour un format particulier et fournit des options denregistrement communes pour tous les nœuds enfants du document.
type: docs
weight: 780
