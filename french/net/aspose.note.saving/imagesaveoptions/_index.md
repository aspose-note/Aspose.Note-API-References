...
description: Permet de spécifier des options supplémentaires lors du rendu des pages de document en images.
type: docs
weight: 700
...
| Nom | La description |
| --- | --- |
| [ImageSaveOptions](imagesaveoptions)(SaveFormat) | Initialise une nouvelle instance du[`ImageSaveOptions`](../imagesaveoptions) classe. |
