...
description: ImageSaveOptions propriété. Obtient ou définit le type de compression à utiliser lors de lenregistrement des images générées au format TIFF.
type: docs
weight: 60
