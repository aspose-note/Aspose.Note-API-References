...
description: Table propiedad. Obtiene o establece un valor que indica si el borde de la tabla está visible.
type: docs
weight: 30
url: /es/net/aspose.note/table/isbordersvisible/
---
## Table.IsBordersVisible property

Obtiene o establece un valor que indica si el borde de la tabla está visible.
