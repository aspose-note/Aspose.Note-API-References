...
description: Propiedad TextStyle. Obsoleto desde la versión 22.5. Use HyperlinkAddress en su lugar.
type: docs
weight: 80
...
Obsoleto desde la versión 22.5. Use `HyperlinkAddress` en su lugar.
