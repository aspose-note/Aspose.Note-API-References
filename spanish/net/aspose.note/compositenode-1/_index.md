...
| [GetEnumerator](../../aspose.note/compositenode`1/getenumerator)() | Devuelve un enumerador que itera a través de los nodos secundarios del[`CompositeNode`](../compositenode-1) . |
