...
description: Representa una columna de tabla.
type: docs
weight: 890
...
| Nombre | Descripción |
| --- | --- |
| [LockedWidth](../../aspose.note/tablecolumn/lockedwidth) { get; set; } | Obtiene o establece un valor que indica si una columna de la tabla tiene un ancho bloqueado y no cambia de tamaño automáticamente para ajustarse al contenido de la tabla. De forma predeterminada, el ancho de la columna no está bloqueado. |
