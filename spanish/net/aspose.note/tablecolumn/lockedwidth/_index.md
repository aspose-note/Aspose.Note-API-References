...
description: Obtiene o establece un valor que indica si una columna de la tabla tiene un ancho bloqueado y no cambia de tamaño automáticamente para ajustarse al contenido de la tabla. De forma predeterminada el ancho de la columna no está bloqueado.
type: docs
weight: 20
...
Obtiene o establece un valor que indica si una columna de la tabla tiene un ancho bloqueado y no cambia de tamaño automáticamente para ajustarse al contenido de la tabla. De forma predeterminada, el ancho de la columna no está bloqueado.
