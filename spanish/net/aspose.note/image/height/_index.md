...
description: Image propiedad. Obtiene o establece la altura. Esta es la altura real de la imagen en el documento de MS OneNote.
type: docs
weight: 90
url: /es/net/aspose.note/image/height/
---
## Image.Height property

Obtiene o establece la altura. Esta es la altura real de la imagen en el documento de MS OneNote.
