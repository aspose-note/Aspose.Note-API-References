...
description: Obtiene elPageHistoryaspose.note/pagehistory que contiene el historial completo de cada página presentada en un documento la más antigua en el índice 0. Se puede acceder a la revisión de la página actual comoCurrentaspose.note/pagehistory/current contenido por separado de la colección de versiones históricas.
type: docs
weight: 100
...
Obtiene el[`PageHistory`](../../pagehistory) que contiene el historial completo de cada página presentada en un documento (la más antigua en el índice 0). Se puede acceder a la revisión de la página actual como[`Current`](../../pagehistory/current) contenido por separado de la colección de versiones históricas.
