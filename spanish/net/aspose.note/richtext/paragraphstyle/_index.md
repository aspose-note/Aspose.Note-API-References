...
description: Obtiene o establece el estilo de párrafo. Esta configuración se usa si no hay un objeto TextStyle coincidente enStyles colección este objeto no especifica una configuración necesaria.
type: docs
weight: 60
