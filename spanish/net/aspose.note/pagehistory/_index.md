...
| Nombre | Descripción |
| --- | --- |
| [PageHistory](pagehistory)(Page) | Inicializa una nueva instancia del[`PageHistory`](../pagehistory) clase. |
...
| [Item](../../aspose.note/pagehistory/item) { get; set; } | Obtiene o establece la versión de la página en el índice especificado del[`PageHistory`](../pagehistory) . |

## Métodos

| Nombre | Descripción |
| --- | --- |
| [Add](../../aspose.note/pagehistory/add)(Page) | Agrega la versión de la página al final de la[`PageHistory`](../pagehistory) . |
| [AddRange](../../aspose.note/pagehistory/addrange)(IEnumerable&lt;Page&gt;) | Agrega las versiones de página al final de la[`PageHistory`](../pagehistory) . |
...
| [GetEnumerator](../../aspose.note/pagehistory/getenumerator)() | Devuelve un enumerador que itera a través de los nodos secundarios del[`PageHistory`](../pagehistory) . |
...
| [Remove](../../aspose.note/pagehistory/remove)(Page) | Elimina la versión de página de la[`PageHistory`](../pagehistory) . |
| [RemoveAt](../../aspose.note/pagehistory/removeat)(int) | Elimina la versión de la página en el índice especificado del[`PageHistory`](../pagehistory) . |
| [RemoveRange](../../aspose.note/pagehistory/removerange)(int, int) | Elimina un rango de versiones de página de la[`PageHistory`](../pagehistory) . |
