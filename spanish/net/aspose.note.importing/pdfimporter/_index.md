...
description: La clase que proporciona api para importar contenido de documentos en formato PDF. La api permite importar desde documentos PDF ubicados en un archivo o en una secuencia usando opciones específicas. Las opciones de importación se pasan usandoPdfImportOptions./pdfimportoptions .
type: docs
weight: 260
