...
description: ElImportingEl espacio de nombres contiene clases que proporcionan API para importar contenido de documentos en formato PDF.
type: docs
weight: 30
url: /es/net/aspose.note.importing/
---
ElImportingEl espacio de nombres contiene clases que proporcionan API para importar contenido de documentos en formato PDF.
