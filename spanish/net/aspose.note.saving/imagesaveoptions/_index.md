...
description: Permite especificar opciones adicionales al representar páginas de documentos en imágenes.
type: docs
weight: 700
...
| Nombre | Descripción |
| --- | --- |
| [ImageSaveOptions](imagesaveoptions)(SaveFormat) | Inicializa una nueva instancia del[`ImageSaveOptions`](../imagesaveoptions) clase. |
