...
description: Permite especificar opciones adicionales al representar las páginas del cuaderno en imágenes.
type: docs
weight: 740
...
| Nombre | Descripción |
| --- | --- |
| [NotebookImageSaveOptions](notebookimagesaveoptions)(SaveFormat) | Inicializa una nueva instancia del[`NotebookImageSaveOptions`](../notebookimagesaveoptions) clase. |
