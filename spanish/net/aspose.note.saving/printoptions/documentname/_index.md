...
description: Obtiene o establece el nombre del documento que se mostrará por ejemplo en un cuadro de diálogo de estado de impresión o en la cola de la impresora mientras se imprime el documento.
type: docs
weight: 20
