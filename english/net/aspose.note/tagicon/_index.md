...
| Home | `23` | Home icon. |
| CommentBubble | `24` | Comment bubble icon. |
...
| RedFlagCheckBox | `98` | Red flag check box icon. |
...
| Research | `135` | Research (books with a magnifying glass) icon. |
