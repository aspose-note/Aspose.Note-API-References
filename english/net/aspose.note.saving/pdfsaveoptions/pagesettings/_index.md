...
description: Gets or sets the page settings for each page in document. By default depends on CurrentUICulture US cultures have letter setting other have A4 settings.
type: docs
weight: 40
