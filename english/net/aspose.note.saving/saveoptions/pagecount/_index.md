...
description: SaveOptions property. Gets or sets the number of pages to save. By default is MaxValue which means all pages of the document will be rendered
type: docs
weight: 20
