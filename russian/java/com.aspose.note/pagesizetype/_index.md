...
description: "Указывает размер типа узла страницы."
type: docs
weight: 73
url: /ru/java/com.aspose.note/pagesizetype/
---
...
Указывает размер типа узла страницы.
## Поля
...
| [ISOA3](#ISOA3) | ISO A3 (297 мм x 420 мм). |
| [ISOA4](#ISOA4) | ISO A4 (210 мм x 297 мм). |
| [ISOA5](#ISOA5) | ISO A5 (148mm x 210mm). |
| [ISOA6](#ISOA6) | ISO A6 (105mm x 148mm). |
| [IndexCard](#IndexCard) | Карточка (3\" x 5\"). |
| [JISB4](#JISB4) | JIS B4 (257mm x 364mm). |
| [JISB5](#JISB5) | JIS B5 (182mm x 257mm). |
| [JISB6](#JISB6) | JIS B6 (128mm x 182mm). |
| [JapanesePostcard](#JapanesePostcard) | Японская открытка (100mm x 148mm). |
| [SizeByContent](#SizeByContent) | Страница не имеет фиксированного размера. |
| [USLegal](#USLegal) | США. |
| [USStatement](#USStatement) | США. |
...
Японская открытка (100mm x 148mm).
...
Страница не имеет фиксированного размера. Она автоматически изменяется, чтобы вместить всё содержимое.
