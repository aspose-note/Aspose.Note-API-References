...
description: Получает или задает пороговое значение для метода бинаризации с фиксированным порогом. Значение по умолчанию  128.
type: docs
weight: 30
...
Показывает, как сохранить документ в виде двоичного изображения с использованием фиксированного порога.
