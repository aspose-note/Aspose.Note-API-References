...
description: Получает или задает текстовое представление встроенного файла. Строка НЕ ДОЛЖНА содержать символы со значением 10 перевод строки или 13 возврат каретки.
type: docs
weight: 190
