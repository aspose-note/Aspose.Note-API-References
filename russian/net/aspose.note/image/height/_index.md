...
description: Image свойство. Получает или задает высоту. Это реальная высота изображения в документе MS OneNote.
type: docs
weight: 90
url: /ru/net/aspose.note/image/height/
---
## Image.Height property

Получает или задает высоту. Это реальная высота изображения в документе MS OneNote.
