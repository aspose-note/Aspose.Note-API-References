...
| CommentBubble | `24` | Значок пузыря комментариев. |
...
| GreenStar | `61` | Значок зеленой звезды. |
...
| RedFlagCheckBox | `98` | Значок красного флажка. |
...
| Research | `135` | Значок Исследования (книги с увеличительным стеклом). |
