...
description: Получает или задает значение указывающее должен ли загрузчик документов игнорировать историю. Используйте этот параметр чтобы уменьшить использование памяти и ЦП. Значение по умолчаниюистинный .
type: docs
weight: 30
