...
description: Задает формат нумерации который можно использовать для группы автоматически нумеруемых объектов. Полный список указан наMSDNhttps//msdn.microsoft.com/en-us/library/dd923798voffice.12.aspx
type: docs
weight: 410
...
Задает формат нумерации, который можно использовать для группы автоматически нумеруемых объектов. Полный список указан на[MSDN](https://msdn.microsoft.com/en-us/library/dd923798(v=office.12).aspx)
...
| UpperLetter | `3` | Указывает, что последовательность должна состоять из одного или нескольких вхождений одной буквы латинского алфавита в верхнем регистре. Пример:A, B, C, …, Y, Z, AA, BB, CC, …, YY, ZZ, AAA, BBB, CCC. |
| LowerLetter | `4` | Указывает, что последовательность должна состоять из одного или нескольких вхождений одной буквы латинского алфавита в нижнем регистре. Пример:a, b, c, …, y, z, aa, bb, cc, …, yy, zz, aaa, bbb, ccc. |
