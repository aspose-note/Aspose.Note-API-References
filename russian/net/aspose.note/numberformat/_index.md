...
description: Определяет формат нумерации который можно использовать для группы автоматически нумерованных объектов. Полный список указан наMSDNhttps//msdn.microsoft.com/en-us/library/dd923798voffice.12.aspx
type: docs
weight: 410
