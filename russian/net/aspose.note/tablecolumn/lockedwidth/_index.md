...
description: Получает или задает значение указывающее имеет ли столбец таблицы заблокированную ширину и не изменяет ли он автоматически размер в соответствии с содержимым таблицы. По умолчанию ширина столбца не заблокирована.
type: docs
weight: 20
...
Получает или задает значение, указывающее, имеет ли столбец таблицы заблокированную ширину и не изменяет ли он автоматически размер в соответствии с содержимым таблицы. По умолчанию ширина столбца не заблокирована.
