...
description: Aspose.Note.TableColumn сорт. Представляет столбец таблицы.
type: docs
weight: 920
url: /ru/net/aspose.note/tablecolumn/
---
## TableColumn class
...
| Имя | Описание |
| --- | --- |
| [TableColumn](tablecolumn/)() | Конструктор по умолчанию. |
