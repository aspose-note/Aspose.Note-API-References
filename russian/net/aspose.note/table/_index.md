...
| Имя | Описание |
| --- | --- |
| [Table](table#constructor)() | Инициализирует новый экземпляр класса[`Table`](../table). |
...
| [LastModifiedTime](../../aspose.note/table/lastmodifiedtime) { get; set; } | Получает или задает время последнего изменения. |
