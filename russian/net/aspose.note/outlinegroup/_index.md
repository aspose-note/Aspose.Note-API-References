...
description: Представляет OutlineGroup.
type: docs
weight: 450
url: /ru/net/aspose.note/outlinegroup/
---
## OutlineGroup class
...
| [IndentPosition](../../aspose.note/outlinegroup/indentposition) { get; set; } | Получает или задает позицию отступа. |
...
| Имя | Описание |
| --- | --- |
| override [Accept](../../aspose.note/outlinegroup/accept)(DocumentVisitor) | Принимает посетителя узла. |
