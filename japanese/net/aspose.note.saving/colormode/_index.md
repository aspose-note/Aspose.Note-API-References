...
description: Aspose.Note.Saving.ColorMode 列挙. 画像のカラーモード.
type: docs
weight: 570
url: /ja/net/aspose.note.saving/colormode/
---
...
| --- | --- | --- |
| Normal | `0` | フルカラー画像 |
| GrayScale | `1` | グレースケール画像 |
| BlackAndWhite | `2` | バイナリ イメージ: 黒と白の色のみが使用されます |
