...
description: Sağlanan PDF belgesinden bir dizi sayfayı içe aktarır.
type: docs
weight: 110
...
| Parametre | Tip | Tanım |
| --- | --- | --- |
| stream | Stream | PDF belgesi içeren bir akış. |
| importOptions | PdfImportOptions | Sayfaların PDF belgesinden nasıl içe aktarılacağı seçeneklerini belirtir. |
