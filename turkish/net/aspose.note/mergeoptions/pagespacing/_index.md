...
description: MergeOptions mülk. Tek bir sayfa olarak içe aktarıldığında sayfalar arasındaki boşluğu alır veya ayarlar.
type: docs
weight: 50
url: /tr/net/aspose.note/mergeoptions/pagespacing/
---
## MergeOptions.PageSpacing property

Tek bir sayfa olarak içe aktarıldığında sayfalar arasındaki boşluğu alır veya ayarlar.
