...
description: CheckBox mülk. CheckBoxın kontrol edilmiş durumda olup olmadığını gösteren bir değer alır.
type: docs
weight: 10
url: /tr/net/aspose.note/checkbox/checked/
---
## CheckBox.Checked property

CheckBox'ın kontrol edilmiş durumda olup olmadığını gösteren bir değer alır.
