...
description: CheckBoxın kontrol edilen durumda olup olmadığını gösteren bir değer alır.
type: docs
weight: 10
...
CheckBox'ın kontrol edilen durumda olup olmadığını gösteren bir değer alır.
