...
| static [CreateScheduledTask](../../aspose.note/notetag/createscheduledtask/)(string) | ZamanlanmışGörev simgesi ve belirtilen etiketle yeni bir not etiketi oluşturur. |
