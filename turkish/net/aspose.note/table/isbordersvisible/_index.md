...
description: Table mülk. Tablo kenarlığının görünür olup olmadığını belirten bir değer alır veya ayarlar.
type: docs
weight: 30
url: /tr/net/aspose.note/table/isbordersvisible/
---
## Table.IsBordersVisible property

Tablo kenarlığının görünür olup olmadığını belirten bir değer alır veya ayarlar.
