...
description: Bu sınıf aşağıdakilerin ortak özelliklerini içerirParagraphStyle./paragraphstyleveTextStyle./textstyle sınıflar.
type: docs
weight: 860
...
Bu sınıf, aşağıdakilerin ortak özelliklerini içerir:[`ParagraphStyle`](../paragraphstyle)ve[`TextStyle`](../textstyle) sınıflar.
...
| İsim | Tanım |
| --- | --- |
| override [GetHashCode](../../aspose.note/style/gethashcode)() | type. için bir karma işlevi olarak hizmet eder |
