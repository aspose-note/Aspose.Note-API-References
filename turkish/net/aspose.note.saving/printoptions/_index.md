...
description: Bir belgeyi yazdırmak için kullanılan seçenekler.
type: docs
weight: 830
...
| İsim | Tanım |
| --- | --- |
| [DocumentName](../../aspose.note.saving/printoptions/documentname) { get; set; } | Belge yazdırılırken görüntülenecek (örneğin, bir yazdırma durumu iletişim kutusunda veya yazıcı kuyruğunda) belge adını alır veya ayarlar. |
...
| [Resolution](../../aspose.note.saving/printoptions/resolution) { get; set; } | Oluşturulan görüntülerin çözünürlüğünü inç başına nokta olarak alır veya ayarlar. |
