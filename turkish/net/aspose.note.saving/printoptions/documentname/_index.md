...
description: Belge yazdırılırken görüntülenecek örneğin bir yazdırma durumu iletişim kutusunda veya yazıcı kuyruğunda belge adını alır veya ayarlar.
type: docs
weight: 20
...
Belge yazdırılırken görüntülenecek (örneğin, bir yazdırma durumu iletişim kutusunda veya yazıcı kuyruğunda) belge adını alır veya ayarlar.
