...
description: Bir görüntü için ikilileştirme yöntemini belirtir.
type: docs
weight: 540
...
Bir görüntü için ikilileştirme yöntemini belirtir.
...
| Otsu | `1` | Görüntünün ikilileştirilmesi, eşiği değerlendirmek için Otsu'nun yöntemi kullanılarak uyarlamalı olarak gerçekleştirilir. |
