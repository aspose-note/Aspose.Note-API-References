...
description: Aspose.Note.Saving.NotebookSaveOptions sınıf. Belirli bir biçim için not defteri kaydetme seçeneklerini temsil eden soyut bir temel sınıf.
type: docs
weight: 790
...
| İsim | Tanım |
| --- | --- |
| abstract [GetDocumentSaveOptions](../../aspose.note.saving/notebooksaveoptions/getdocumentsaveoptions/)() | Not defterinin tüm alt belgeleri için kaydetme seçeneklerini alır. |
