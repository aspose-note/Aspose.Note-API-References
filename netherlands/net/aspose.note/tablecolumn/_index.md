...
description: Aspose.Note.TableColumn klas. Vertegenwoordigt een tabelkolom.
type: docs
weight: 920
url: /nl/net/aspose.note/tablecolumn/
---
## TableColumn class

Vertegenwoordigt een tabelkolom.
...
| Naam | Beschrijving |
| --- | --- |
| [TableColumn](tablecolumn/)() | De standaard constructeur. |

## Eigenschappen

| Naam | Beschrijving |
| --- | --- |
| [LockedWidth](../../aspose.note/tablecolumn/lockedwidth/) { get; set; } | Hiermee wordt een waarde opgehaald of ingesteld die aangeeft of een tabelkolom een vergrendelde breedte heeft en niet automatisch wordt aangepast aan de inhoud van de tabel. Standaard is de kolombreedte niet vergrendeld. |
| [Width](../../aspose.note/tablecolumn/width/) { get; set; } | Haalt of stelt de breedte in. |
