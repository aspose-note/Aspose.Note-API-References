...
description: Aspose.Note.OutlineElement kelas. Mewakili OutlineElement.
type: docs
weight: 460
url: /id/net/aspose.note/outlineelement/
---
## OutlineElement class

Mewakili OutlineElement.
...
| Nama | Keterangan |
| --- | --- |
| [OutlineElement](outlineelement/#constructor)() | Menginisialisasi instance baru dari`OutlineElement` kelas. |

## Properti

| Nama | Keterangan |
| --- | --- |
| [CreationTime](../../aspose.note/outlineelement/creationtime/) { get; set; } | Mendapatkan atau menyetel waktu pembuatan. |
...
| [LastModifiedTime](../../aspose.note/outlineelement/lastmodifiedtime/) { get; set; } | Mendapatkan atau menyetel waktu modifikasi terakhir. |
...
| [NumberList](../../aspose.note/outlineelement/numberlist/) { get; set; } | Mendapat atau mengatur gaya untuk header daftar bernomor. |
...
| Nama | Keterangan |
| --- | --- |
| override [Accept](../../aspose.note/outlineelement/accept/)(DocumentVisitor) | Menerima pengunjung node. |
